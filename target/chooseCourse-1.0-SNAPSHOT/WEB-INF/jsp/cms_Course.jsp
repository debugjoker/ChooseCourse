...
<div class="container-fluid">
    <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
            ...
            <ul class="nav nav-sidebar">
                <li class="active"><a href="javascript:void(0)">查询所有课程信息（更改 删除 详情->某个课程选的具体学生名单）</a></li>
                ...
                <table class="table table-striped">
                    ...
                    <c:forEach var="courses" items="${courseList}">
                        <tr>
                            ...
                            <td><fmt:formatDate value="${courses.startTime}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
                            <td><fmt:formatDate value="${courses.endTime}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
                            <td>
                                <div class="td_length">
                                    <a class="btn btn-primary" href="/admin/course/${courses.courseId}/chooseDetail" role="button">详情</a>
                                    <a class="btn btn-success" href="/admin/course/${courses.courseId}/detail" role="button">修改</a>
                                    <form action="/admin/course/${courses.courseId}/delete" method="post" class="pull-right">
