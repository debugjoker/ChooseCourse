    ...
    <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
            <ul class="nav nav-sidebar">
                <li class="active"><a href="/admin/user/showlist">查询所有用户信息（更改 删除）<span class="sr-only">(current)</span></a></li>
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            ...
            <form action="/admin/${thisUser.studentId}/update" method="post">
                <%--<fieldset disabled>--%>
                    <%----%>
                <%--</fieldset>--%>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="studentId" id="InputId" value="${thisUser.studentId}">
                </div>

                <div class="form-group">
                    <label for="InputName">姓名</label>
                    <input type="text" class="form-control" name="studentName" id="InputName" value="${thisUser.studentName}">
                </div>

                <div class="form-group">
                    <label for="InputPassword">密码</label>
                    <input type="text" class="form-control" name="studentPassword" id="InputPassword" value="${thisUser.studentPassword}">
                </div>

                <div class="form-group">
                    <label for="InputClassName">班级</label>
                    <input type="text" class="form-control" name="studentClassName" id="InputClassName" value="${thisUser.studentClassName}">
                </div>
