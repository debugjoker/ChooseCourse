    ...
    <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
            <ul class="nav nav-sidebar">
                <li><a href="/admin/user/showlist">查询所有用户信息（更改 删除）<span class="sr-only">(current)</span></a></li>
                <li><a href="#" data-toggle="modal" data-target="#myModal">添加用户信息</a></li>
            </ul>
            <ul class="nav nav-sidebar">
                <li class="active"><a href="/admin/course/list">查询所有课程信息（更改 删除 详情->某个课程选的具体学生名单）</a></li>
                <li><a href="#" data-toggle="modal" data-target="#CourseModal">添加课程信息</a></li>
            </ul>
        </div>
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">

            <form action="/admin/course/${thisCourse.courseId}/update" method="post">
                <%--<fieldset disabled>--%>
                <%----%>
                <%--</fieldset>--%>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="courseName" id="InputName" value="${thisCourse.courseName}">
                </div>

                <div class="form-group">
                    <label for="InputNumber">课程数量</label>
                    <input type="text" class="form-control" name="courseNumber" id="InputNumber" value="${thisCourse.courseNumber}">
                </div>

                <div class="form-group">
                    <label for="InputStart">选课开始时间</label>
                    <input type="datetime-local" class="form-control" name="startTime" id="InputStart">
                </div>

                <div class="form-group">
                    <label for="InputEnd">选课结束时间</label>
                    <input type="datetime-local" class="form-control" name="endTime" id="InputEnd">
                </div>
